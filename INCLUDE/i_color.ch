...
#xtranslate   COLOR_Aqua               =>   {   0 , 255 , 255 }
...
#xtranslate   COLOR_Crimson            =>   { 220 ,  20 ,  60 }
...
#xtranslate   COLOR_DarkGray           =>   { 169 , 169 , 169 }
...
#xtranslate   COLOR_Fuchsia            =>   { 255 ,   0 , 255 }
...
#xtranslate   COLOR_Gray               =>   { 128 , 128 , 128 }
...
#xtranslate   COLOR_Indigo             =>   {  75 ,   0 , 130 }
...
#xtranslate   COLOR_RebeccaPurple      =>   { 102 ,  51 , 153 }       
...
#xtranslate   COLOR_Silver             =>   { 192 , 192 , 192 }
...
#xtranslate   COLOR_Teal               =>   {   0 , 128 , 128 }
