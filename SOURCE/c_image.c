...
// 9. TransparentColor
    ...
    HG_pstr( ImgFile ); ImgFile = HG_parc(2);
    ...
    hBitmap = HMG_LoadPicture (ImgFile, hb_parni(3), hb_parni(4), (HWND) HMG_parnl(1), ScaleStretch, Transparent, BackgroundColor, AdjustImage, TransparentColor);
