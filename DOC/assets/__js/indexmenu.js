...
c++; item[c]=new Array("rangemax.htm","","rangemax","","Specifies the maximun value that can be entered in a Spinner control","Properties");
c++; item[c]=new Array("rangemin.htm","","rangemin","","Specifies the minimun value that can be entered in a Spinner control","Properties");
